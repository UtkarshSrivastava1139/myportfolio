...
const Hero = () => {
  ...
  const fullText = "Turning ideas into impactful, real-world solutions.";
    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-200 dark:bg-blue-900 rounded-full opacity-20 blur-3xl"
        />
        <motion.div
          animate={{
            rotate: -360,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          >
            <Link href="/resume">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="btn-primary flex items-center gap-2 px-8 py-4 text-lg cursor-pointer"
              >
                <Eye size={20} />
                View Resume
              </motion.div>
          ...
          >
            ...
            <motion.a
              href="https://linkedin.com/in/utkarshsri1139"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1 }}
