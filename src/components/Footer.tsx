...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/utkarshsri1139",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/in/utkarsh-srivastava",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/utkarshsri1139",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-white relative overflow-hidden" ref={ref}>
      {/* Background Pattern */}
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                functional, and user-friendly web applications. I specialize in modern 
                web technologies and enjoy solving complex problems with elegant solutions.
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-gray-300">
                  <Mail className="w-4 h-4 mr-2" />
                  <span>utkarsh.srivastava@email.com</span>
                </div>
                <div className="flex items-center text-gray-300">
        ...
        <div className="border-t border-gray-800">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              >
                <span>© {currentYear} Utkarsh Srivastava. Made with</span>
